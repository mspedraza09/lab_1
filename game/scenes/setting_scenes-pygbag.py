...
class Sonido:
    def __init__(self):
        ...
        ruta_sonido = os.path.join(directorio_actual, "elementos","End-of-Line-_From-TRON_-Legacy_Score_.ogg")
        ruta = "game/scenes/elementos/End-of-Line-_From-TRON_-Legacy_Score_.ogg"
